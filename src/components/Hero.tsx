...
export default function Hero() {
  return (
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      {/* Overlay gradient */}
      <div className="absolute inset-0 bg-gradient-to-t from-minecraft-dark via-black/70 to-transparent" />
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-up [animation-delay:600ms]">
            <Button
              size="lg"
              className="bg-gradient-to-r from-minecraft-primary to-minecraft-secondary hover:from-minecraft-primary/90 hover:to-minecraft-secondary/90 text-white px-8 py-6 text-lg rounded-lg flex items-center gap-2 transform transition-all duration-300 hover:scale-105 backdrop-blur-sm"
            >
